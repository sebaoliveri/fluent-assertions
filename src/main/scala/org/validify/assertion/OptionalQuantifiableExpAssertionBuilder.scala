...
object OptionalQuantifiableExpAssertionBuilder {
  ...
  def apply[T,R](optionalExp: OptionalExp[T,Ordered[R]], expression: ComposableBooleanExp[T]): OptionalQuantifiableExpAssertionBuilder[T,R] =
    new OptionalQuantifiableExpAssertionBuilder(optionalExp, expression, _ and _)
}

case class OptionalQuantifiableExpAssertionBuilder[T,R](optionExp: OptionalExp[T,Ordered[R]], expression: ComposableBooleanExp[T], operator: (ComposableBooleanExp[T], ComposableBooleanExp[T]) => ComposableBooleanExp[T])
